package ru.geekbrains.lesson5v2.views;
...
import ru.geekbrains.lesson5v2.presenters.ViewObserver;
...
public class BookingView implements View {
    ...
    public void showDeleteReservationTableResult(int tableNo, boolean result) {
        if (result) {
            ...
            System.out.printf("Не удалось отменить бронирование столика %d, проверьте корректность вводимых данных.\n", tableNo);
        }
    }
